...
diy_script_3=diy_script/immortalwrt_diy/diy-part3.sh
# 依赖列表
my_depends=https://raw.githubusercontent.com/smallprogram/OpenWrtAction/refs/heads/main/diy_script/immortalwrt_dependence
