...
# 编译子文件夹名称
folder_name=log_immortalwrt_Compile_${config_name}_$(date "+%Y-%m-%d-%H-%M-%S")
#清理超过多少天的日志文件
clean_day=3
# 编译结果变量
is_complie_error=0
...
function Func_DIY1_Script() {
    ...
    bash ../OpenWrtAction/diy_script/immortalwrt_diy/diy-part1.sh
...
function Func_DIY2_Script() {
    ...
    bash ../OpenWrtAction/diy_script/immortalwrt_diy/diy-part2.sh
