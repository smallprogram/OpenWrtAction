...
echo "passwall_packages:$(git -C openwrt/feeds/passwall_packages log -n 1 --format="%H")" >>git_log_${source_code_platform}.txt
echo "passwall:$(git -C openwrt/feeds/passwall log -n 1 --format="%H")" >>git_log_${source_code_platform}.txt
echo "passwall2:$(git -C openwrt/feeds/passwall2 log -n 1 --format="%H")" >>git_log_${source_code_platform}.txt
